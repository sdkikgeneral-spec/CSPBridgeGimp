...
/** @brief GET リクエスト累計カウンター（FilterRun ごとにリセット） */
extern std::atomic<int32_t> g_tileGetCount;
/** @brief PUT リクエスト累計カウンター（FilterRun ごとにリセット） */
extern std::atomic<int32_t> g_tilePutCount;
